...
toolbar_icobase = "../../plugins/toolbar/images/";
...
if(window.toolbar != undefined) {
	...
	/* bouton inclusion pdf */
	toolbar[toolbar.length] = {
		"type"   : "format",
		"title"  : "inclusion pdf",
		"sample" : " ",
		"icon"   : toolbar_icobase+"pdf.gif",
		"open"   : "{{pdfjs 800px > chemin:du:pdf?disp=tab|nom du fichier.pdf",
		"close"  : "| }}",
		"block"  : false,
	};
/* bouton inclusion page */
	toolbar[toolbar.length] = {
		"type"   : "format",
		"title"  : "inclusion page",
		"sample" : " ",
		"icon"   : toolbar_icobase+"lc_insertctrl.png",
		"open"   : "{{page>chemin:de:la:page" ,
		"close"  : "| }}",
		"block"  : false,
	};
/* bouton code */
...
/* bouton section collapse */
	toolbar[toolbar.length] = {
		"type"   : "picker",
		"title"  : "Section masqué",
		"icon"   : toolbar_icobase+"lc_outlinecollapse.png",
		"class"  : "pk_hl",
		"block"  : true,		
		"list"   : [{
			"type"   : "format",
			"title"  : "Section masquée simple",
			"icon"   : toolbar_icobase+"lc_outlinecollapse.png",
			"open"   : "\n--> ",
			"close"  : "#\n\n<--\n",
		},{
			"type"   : "format",
			"title"  : "Section masquée incluse",
			"icon"   : toolbar_icobase+"lc_outlineexpandall.png",
			"open"   : "\n--> ",
			"close"  : "#\n{{page> page_a_inclure&inline}}\n<--\n",
		}]
	};
}
